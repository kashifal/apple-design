<template>
  <div>
    <Carousel />
    <div class="md:flex hidden flex-col gap-6 lg:flex-row">
      <div
        class="rounded-lg bg-[#F6F5F8] bg-cover bg-center object-cover px-4 py-3 lg:h-[415px] lg:w-1/2"
      >
        <button
          class="font-[SF Pro Display,SF Pro Icons,Helvetica Neue,Helvetica,Arial,sans-serif] rounded-[5px] bg-[#DAEAFF] px-2 py-1 text-sm font-medium text-[#6076B5]"
        >
          Special Edition
        </button>
